...
package com.panov_prime.apptrade.view.adapter;
...
import com.panov_prime.apptrade.util.ColorGenerator;
import com.panov_prime.apptrade.util.Utils;
import com.panov_prime.apptrade.view.activities.ECartHomeActivity;
import com.panov_prime.apptrade.view.customview.ItemTouchHelperAdapter;
import com.panov_prime.apptrade.view.customview.ItemTouchHelperViewHolder;
import com.panov_prime.apptrade.view.customview.OnStartDragListener;
import com.panov_prime.apptrade.view.customview.TextDrawable;
import com.panov_prime.apptrade.view.customview.TextDrawable.IBuilder;
import com.panov_prime.apptrade.view.fragment.MyCartFragment;
...
public class ShoppingListAdapter extends
	...
	public void onBindViewHolder(final ItemViewHolder holder, final int position) {
		...
		String sellCostString = Money.hrivnia(
				BigDecimal.valueOf(Long.valueOf(productList.get(position)
						.getSellMRP()))).toString()
				+ "  ";

		String buyMRP = Money.hrivnia(
				BigDecimal.valueOf(Long.valueOf(productList.get(position)
						.getMRP()))).toString();
